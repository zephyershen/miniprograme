...
- AI HOT 近 7 天 108 条 AI/科技精选已在后台接入；公开首页不显示聚合平台、接口或缓存信息，只展示其中 13 条已有真实原文封面的资讯，不再使用分类视觉兜底。娱乐、社会、游戏和英语仍待独立来源。
- 首页支持时间、公司与模型、技术方向组合筛选；筛选项附结果数，空选项不可选。
- 资讯详情提供 30 秒导读、完整上游摘要分段和三条有图相关阅读，不再按字符截断或添加人工省略号；当前没有已验证的外部业务域名，原文操作会复制链接供浏览器打开。
