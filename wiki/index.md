...
- 小程序页面：纯资讯首页、短读资讯详情、条件式原始出处页，以及暂未从首页开放的个人阅读详情、收藏、设置
...
- AI HOT 的 20 条 AI/科技精选已在后台接入；公开首页不显示聚合平台、接口或缓存信息，只展示其中 7 条已有真实原文封面的资讯，不再使用分类视觉兜底。娱乐、社会、游戏和英语仍待独立来源。
- 资讯详情提供 30 秒导读、三条关键信息和三条有图相关阅读；当前没有已验证的外部业务域名，原文操作会复制链接供浏览器打开。
