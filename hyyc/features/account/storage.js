...
function viewerAccountVerified(access, wxApi = currentWxApi()) {
...
function rememberViewerAccount(access, wxApi = currentWxApi()) {
  const partition = accountPartition(access);
...
function forgetViewerAccount(access, wxApi = currentWxApi()) {
  const partition = accountPartition(access);
  if (!partition
    || !wxApi
