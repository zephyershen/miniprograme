...
const CHANNEL_RULES = Object.freeze([
  {
    key: 'ai',
    pattern: /openai|chatgpt|grok|deepseek|glm|gpt|人工智能|大模型|模型|智谱|深度求索|生成式\s*ai|\bai\b/i
  },
  {
    key: 'games',
    pattern: /游戏|电竞|steam|xbox|playstation|nintendo|switch|手游|主机/i
  },
  {
    key: 'english',
    pattern: /英语|英文|english|vocabulary|grammar|口语|听力|雅思|托福/i
  },
  {
    key: 'entertainment',
    pattern: /娱乐|电影|音乐|综艺|演出|票房|剧集|明星|动漫/i
  },
  {
    key: 'society',
    pattern: /社会|城市|教育|政策|民生|公共|文化|就业|生活/i
  },
  {
    key: 'tech',
    pattern: /科技|技术|芯片|软件|硬件|开发|github|apple|google|microsoft|互联网|机器人/i
  }
]);
...
function inferChannel(entry = {}) {
  const text = [entry.sourceHost, entry.sourceTitle, entry.summaryZh]
    .filter(Boolean)
    .join(' ');
